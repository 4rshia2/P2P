...
let generateIdButton = document.getElementsByClassName("btn generateId");

for(var i = 0;i<generateIdButton.length;i++){
	generateIdButton[i].addEventListener("click" , (event) => {
		event.preventDefault();
		let roomId = uuidGenerator();
		let inputBar = document.getElementById('myInput');
		inputBar.value = roomId;
	})
}

},{"./uuid-Generator":2}],2:[function(require,module,exports){
...
},{"uuid":3}],3:[function(require,module,exports){
"use strict";
